...
In this section, we recall a few basic facts about Kan extensions. These can be found in \cite{kerodon}. Since Kan extensions are defined by the colimit formula, we will start by defining colimits. Clasically, colimits in $\infty$-categories are defined using colimit cones.
